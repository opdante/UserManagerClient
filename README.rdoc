...
If you need information regarding the current user's high school information
    ...
    @high_school_info = access_token.get(UserManagerClient::Engine.config.high_school_info_api_call).parsed if access_token
...
If you need information regarding the current user's college information
    ...
    @college_info = access_token.get(UserManagerClient::Engine.config.college_info_api_call).parsed if access_token
        ["grad_year"]			# date use strftime("%Y")
        ["major"]					# string
